...
def build_halo_prompt(
    ...
    parts = [
        ...
        "using TRACE evidence, include a verbatim raw_log_excerpt copied from its span with enough contiguous",
        "context to show the operation, relevant input/result, and failure; prefer the",
        "triggering call plus decisive output/status/exception (normally 3-20 relevant",
        "lines when available), not only the final exception line. Do not paraphrase it.",
