            ...
            "content": (
                json.dumps(
                    build_report(
                        report_summary={
                            "task_id": "demo",
                            "task": "检查模拟Trace并诊断执行问题。",
                            "trace_ids": [tid_a, tid_b],
                        },
                        execution_classification="UNKNOWN",
                        primary_failure_mode="模拟Trace缺少明确的根执行终止字段，无法可靠确定最终执行状态。",
                        error_findings=[{
                            "error_id": "ERR1",
                            "priority": "P0",
                            "category": "MISSING_TERMINAL_EVIDENCE",
                            "title": "根执行终止证据不足",
                            "occurrence_count": 1,
                            "summary": "模拟数据没有提供足以确定最终执行状态的根Span终止信息。",
                            "evidence": [{
                                "source": "TRACE",
                                "reference": tid_a,
                                "tool": "call_subagent",
                        ...
                        proposed_changes=[
                            {
                                ...
                                "acceptance_criteria": ["诊断报告必须引用根Agent的终止状态证据。"],
                            ...
                            },
                            {
                                ...
                                "acceptance_criteria": ["数据概览必须返回根Span状态和结束时间。"],
                            ...
                            },
                            {
                                ...
                                "acceptance_criteria": ["工具定义必须说明根执行终止字段的判定语义。"],
